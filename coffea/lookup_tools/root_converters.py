...
def convert_histo_root_file(file):
    ...
    for path, item in fin.iteritems(recursive=True):
        ...
        if rootclass in histTypes:
            ...
            deprecate(
                RuntimeError("The support for TGraph-types will be removed in a future coffea release. In case you need support for TGraph-type, please submit an issue to `https://github.com/CoffeaTeam/coffea/issues`."),  # noqa: E501
                "<unknown>",
            )
            continue
