...
class jersf_lookup(lookup_base):
    ...
    def _evaluate(self, *args):
        ...
        parm_values_central = np.array(self._parms[0][bin_tuple])
        parm_values_up = np.array(self._parms[1][bin_tuple])
        parm_values_down = np.array(self._parms[2][bin_tuple])
        parm_values = np.stack(
