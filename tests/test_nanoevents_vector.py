...
def test_lorentz_vector_numba(a_dtype, b_dtype):
    ...
    assert pytest.approx(a.mass) == [48.91829923454004, 49.60846701924985, 50.24937810560445, 50.84289527554464]
    assert pytest.approx((a+b).mass) == [106.14612569472331, 109.20164833920778, 110.66616465749593, 110.68423555321688]
    assert pytest.approx(a.delta_phi(b), abs=1e-7) == [0.03369510734601633, -0.1798534997924781, 0.33292327383538156, 0.6078019961139605]
